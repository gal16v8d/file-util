...
import co.com.gsdd.file.util.model.UploadableSMBFile;
...
public final class SMBUtil {
     ...
     *            local file
     * @param transferSpeed
     *            how many bytes to read/transfer
     * @param printStep
     *            for print the action
     * @return
     */
    public static boolean transferFile(UploadableSMBFile smbf, String file, Integer transferSpeed, Integer printStep) {
    ...
    public static List<SmbFile> getFilesSortedByLastModification(UploadableSMBFile smbf) {
        ...
        try {
            ...
            Comparator<SmbFile> smbFileComparator = (SmbFile p1, SmbFile p2) -> Long.compare(p1.getLastModified(),
                    p2.getLastModified());
